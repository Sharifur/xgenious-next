    ...
    <>
      ...
      <section style={{ background: 'linear-gradient(180deg, #f5f6ea 0%, #f3dacd 100%)' }} className="pt-[100px] pb-[60px] sm:pt-[140px] sm:pb-[100px]">
        <div className="container-page px-4 sm:px-6 lg:px-0 flex flex-col items-center text-center gap-4 sm:gap-6 pb-10 sm:pb-14">
          ...
          <p className="text-[14px] leading-[21px] sm:text-[16px] sm:leading-6 lg:text-[18px] lg:leading-[27px] text-[#2f2f2f] max-w-[550px]">
      ...
      <section className="bg-white pt-14 sm:pt-[100px] pb-14 sm:pb-[100px]">
        <div className="container-page px-4 sm:px-6 lg:px-0">
          ...
          {/* Mobile layout — title + 2-col grid */}
          <div className="lg:hidden flex flex-col gap-6">
            <h2 className="text-[26px] leading-[34px] sm:text-[34px] sm:leading-[42px] font-semibold text-[#181818]">
              Creating experiences Rooted in Authentic culture
            </h2>
            <div className="grid grid-cols-2 gap-3">
              <div className="h-[160px] sm:h-[220px] bg-[#d9d9d9] rounded-2xl" />
              <div className="h-[160px] sm:h-[220px] bg-[#d9d9d9] rounded-2xl mt-8" />
              <div className="h-[160px] sm:h-[220px] bg-[#d9d9d9] rounded-2xl" />
              <div className="h-[160px] sm:h-[220px] bg-[#d9d9d9] rounded-2xl" />
              <div className="col-span-2 h-[140px] sm:h-[180px] bg-[#d9d9d9] rounded-2xl" />
            </div>
          </div>

          {/* Desktop layout — complex 4-col grid */}
          <div
          ...
          >
            ...
            <div className="col-start-4 col-end-5 row-start-1 row-end-3 h-[330px] bg-[#d9d9d9] rounded-2xl self-start" />
