...
const INDUSTRIES: Industry[] = [
  ...
  { icon: <EcommerceIcon />,  industry: 'E-Commerce',     useCases: 'Cart Recovery • Personalization',           image: '/products/nazmart.png' },
  ...
  { icon: <LogisticsIcon />,  industry: 'Logistics',      useCases: 'Route Optimization • Delivery Tracking',    image: null },
