...
const AndroidLogo = () => (
  <svg viewBox="0 0 100 90" width="70" height="70" fill="none">
    <line x1="33" y1="22" x2="23" y2="7" stroke="#3DDC84" strokeWidth="4" strokeLinecap="round"/>
    <circle cx="21" cy="5" r="4" fill="#3DDC84"/>
    <line x1="67" y1="22" x2="77" y2="7" stroke="#3DDC84" strokeWidth="4" strokeLinecap="round"/>
    <circle cx="79" cy="5" r="4" fill="#3DDC84"/>
    <path d="M18 55 L18 38 A32 32 0 0 1 82 38 L82 55 Q82 64 74 64 L26 64 Q18 64 18 55Z" fill="#3DDC84"/>
    <circle cx="37" cy="44" r="5.5" fill="#0d2818"/>
    <circle cx="63" cy="44" r="5.5" fill="#0d2818"/>
    <rect x="18" y="66" width="64" height="24" rx="5" fill="#3DDC84"/>
    <rect x="4"  y="66" width="10" height="22" rx="5" fill="#3DDC84"/>
    <rect x="86" y="66" width="10" height="22" rx="5" fill="#3DDC84"/>
  </svg>
);

const iOSLogo = () => (
  <svg viewBox="0 0 100 120" width="60" height="72" fill="none">
    <path d="M70 30C70 18 62 10 50 10C44 10 38 13 34 17C30 13 24 10 18 12C24 22 22 32 22 40C20 58 32 80 44 80C47 80 51 77 54 77C57 77 61 80 64 80C76 80 85 60 86 44C81 42 70 40 70 30Z" fill="white"/>
    <path d="M52 10C54 1 66 -1 68 6" stroke="white" strokeWidth="3.5" strokeLinecap="round" fill="none"/>
  </svg>
);
...
const ReactNativeLogo = () => (
  <svg viewBox="0 0 100 100" width="70" height="70" fill="none">
    ...
    <ellipse cx="50" cy="50" rx="42" ry="16" stroke="#61DAFB" strokeWidth="3.5" fill="none"/>
    <ellipse cx="50" cy="50" rx="42" ry="16" stroke="#61DAFB" strokeWidth="3.5" fill="none" transform="rotate(60 50 50)"/>
    <ellipse cx="50" cy="50" rx="42" ry="16" stroke="#61DAFB" strokeWidth="3.5" fill="none" transform="rotate(-60 50 50)"/>
  </svg>
);

const FlutterLogo = () => (
  <svg viewBox="0 0 72 90" width="52" height="65" fill="none">
    <polygon points="0,36 20,14 40,14 20,36" fill="#54C5F8"/>
    <polygon points="20,36 40,14 60,14 60,36 40,58" fill="#01579B"/>
    <polygon points="28,66 52,42 64,54 40,78" fill="#29B6F6"/>
    <polygon points="40,78 28,66 40,66" fill="#01579B" opacity="0.6"/>
  </svg>
);
...
const services = [
  {
    ...
    description: 'Powerful Android applications using Kotlin and Jetpack Compose for modern, scalable, and maintainable solutions.',
    platform: 'Android',
    screenBg: 'bg-[#0a1f0f]',
  ...
  },
  {
    ...
    description: 'Native iOS apps built with Swift and SwiftUI, delivering buttery-smooth experiences across iPhone and iPad.',
    platform: 'iOS',
    screenBg: 'bg-black',
  ...
  },
  {
    ...
    description: 'Cross-platform apps with a single codebase that look and feel native on both Android and iOS.',
  ...
  },
  {
    ...
    description: 'Beautiful, natively compiled apps from a single Dart codebase — fast to ship and easy to maintain.',
    platform: 'Flutter',
    screenBg: 'bg-[#01172b]',
