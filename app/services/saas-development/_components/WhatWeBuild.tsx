...
const cards = [
  {
    ...
    description:
      'Row-level or schema-level tenancy, per tenant billing, admin consoles and role based access designed from the schema up.',
  ...
  },
  {
    ...
    description:
      'Fixed-scope MVPs in 8–12 weeks. React + Node or Laravel + Flutter. Productized bases for ecommerce, marketplaces, and services.',
  ...
  },
  {
    ...
    description:
      'Stripe, Paddle, Lemon Squeezy for global — Tabby, Tamara, Mada, STC Pay for GCC. Usage metering, trials, dunning, refunds.',
  ...
  },
  {
    ...
    description:
      'GDPR, HIPAA, SOC 2-ready architectures with audit logs, data-residency options, threat models, and DPA on every engagement.',
  ...
  },
  {
    ...
    description:
      'RAG apps, agentic workflows, evals, and retrofits of existing SaaS. Anthropic Claude, OpenAI, LangChain, Pinecone, pgvector.',
  ...
  },
  {
    ...
    description:
      'AWS / Azure / GCP infrastructure as code, CI/CD pipelines, observability, cost optimization, and post-launch SRE retainers.',
