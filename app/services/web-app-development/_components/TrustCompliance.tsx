...
const cards: ComplianceCard[] = [
  { icon: '/images/web-app-dev/icon-gdpr.svg', iconBg: '#d6e0f0', name: 'GDPR', status: 'Live · DPA available' },
  { icon: '/images/web-app-dev/icon-hipaa.svg', iconBg: '#bdf8ea', name: 'HIPAA', status: 'Ready · BAA on request' },
  { icon: '/images/web-app-dev/icon-soc2.svg', iconBg: '#f5ebda', name: 'SOC 2 Type I', status: 'In progress · Q3 2026' },
  { icon: '/images/web-app-dev/icon-iso.svg', iconBg: '#ede0f2', name: 'ISO 27001', status: 'Roadmap · 2026' },
  { icon: '/images/web-app-dev/icon-pci.svg', iconBg: '#d6e0f0', name: 'PCI DSS', status: 'Ready · Stripe SAQ-A' },
  { icon: '/images/web-app-dev/icon-uae.svg', iconBg: '#bdf8ea', name: 'UAE DIFC', status: 'DIFC/ADGM-compliant' },
  { icon: '/images/web-app-dev/icon-ksa.svg', iconBg: '#f5ebda', name: 'KSA PDPL', status: 'Data-residency in-Kingdom' },
  { icon: '/images/web-app-dev/icon-gdpr.svg', iconBg: '#d6e0f0', name: 'GDPR', status: 'Live · DPA available' },
  { icon: '/images/web-app-dev/icon-eu.svg', iconBg: '#ede0f2', name: 'EU Data Residency', status: 'Frankfurt / Dublin regions' },
];

function ComplianceCard({ icon, iconBg, name, status }: ComplianceCard) {
  return (
        ...
        <div className="flex flex-col items-center gap-4 text-center max-w-[621px]">
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <p className="text-[#484848] font-normal" style={{ fontSize: 16, lineHeight: '24px', maxWidth: 611 }}>
              Every engagement ships a DPA. Every architecture ships with a threat model — honest roadmap, not marketing badges.
            </p>
          </div>
        </div>
