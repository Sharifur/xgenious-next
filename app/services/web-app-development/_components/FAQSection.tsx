...
const faqs = [
  {
    ...
    a: 'Yes. Webflow supports custom HTML, CSS, and JavaScript. You can embed code directly in pages, sections, or globally via the project settings.',
  },
  {
    q: 'How fast can you actually ship a SaaS MVP?',
    a: 'Webflow is a no-code visual development platform that allows you to design, build, and launch fully responsive websites without relying on traditional coding.',
  },
  {
        ...
        <div className="flex flex-col items-center gap-4 text-center max-w-[621px]">
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <p className="text-[#484848] font-normal" style={{ fontSize: 16, lineHeight: '24px', maxWidth: 492 }}>
              The questions every buyer actually asks. If yours isn&apos;t here, ask it on the call — we will answer it honestly.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full">
          {faqs.map((faq, i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-[4px] bg-[#f5f6f8] overflow-hidden"
              >
                <button
                ...
                >
                  ...
                  {isOpen ? (
                    <div className="relative flex-shrink-0 w-8 h-8">
                      ...
                      <img
                        src="/images/web-app-dev/faq-icon-up-bg.svg"
                        alt=""
                        className="absolute inset-0 w-full h-full"
                      />
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src="/images/web-app-dev/faq-icon-up-frame.svg"
                        alt=""
                        className="absolute inset-[4px] w-6 h-6 rotate-180"
                      />
                    </div>
                  ) : (
