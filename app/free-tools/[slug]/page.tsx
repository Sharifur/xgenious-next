      ...
      <section className="py-12 sm:py-16" style={{ background: '#F5F6F8' }}>
        <div className="container-page px-4 sm:px-6 lg:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-10 items-start">
            ...
            {/* Left: how-to + features */}
            <div className="flex flex-col gap-6">
              <div>
                <p className="text-[11px] font-semibold tracking-widest uppercase text-[#9ca3af] mb-3">How to use</p>
                <ol className="flex flex-col gap-4">
                  {tool.howToUse.map(({ step, desc }, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-[13px] font-semibold text-[#0F1112] leading-[1.4]">{step}</p>
                        <p className="text-[12px] text-[#6b7280] leading-[1.6] mt-0.5">{desc}</p>
                      </div>
                    </li>
                  ))}
                </ol>
              ...
              {tool.featureList && tool.featureList.length > 0 && (
                <div>
                  <p className="text-[11px] font-semibold tracking-widest uppercase text-[#9ca3af] mb-3">Features</p>
                  <ul className="flex flex-col gap-2">
                    {tool.featureList.map((f) => (
                      <li key={f} className="flex items-start gap-2 text-[13px] text-[#484848]">
