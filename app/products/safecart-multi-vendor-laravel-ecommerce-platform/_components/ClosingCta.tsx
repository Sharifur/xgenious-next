    ...
    <section className="py-16 sm:py-20 lg:py-[100px]" style={{ background: DARK_BG }}>
      <div className="container-page px-4 sm:px-6 lg:px-0">
        <div className="max-w-[720px] mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[12px] font-semibold uppercase tracking-widest mb-6" style={{ background: `${COLOR}25`, color: '#6ee7b7' }}>
            Get Started Today
          </div>

          <h2 className="text-[32px] sm:text-[48px] font-bold text-white leading-tight mb-5">
            Your Multi-Vendor Marketplace Starts Here
          </h2>

          <p className="text-[#9ca3af] text-[15px] sm:text-[17px] leading-7 mb-8">
            One platform. Multi-vendor dashboards. Three Flutter mobile apps. POS system. Live delivery tracking.
            26+ payment gateways. Campaign countdown timers. All for a one-time price.
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            >
              {`Purchase SafeCart — from $${REGULAR_PRICE}`}
            </a>
            <Link
              href={DEMO_URL}
              target="_blank"
          ...
          <div className="mt-10 pt-8 border-t border-white/10">
            ...
            <div className="flex items-center justify-center gap-5 flex-wrap">
              ...
              <Link
                href="/products/listocean-classified-ads-listing-platform"
                className="text-[13px] text-[#6b7280] underline underline-offset-4 decoration-[#4b5563]/30 hover:text-[#9ca3af] transition-colors"
              >
                ListOcean — Classified Ads Platform
              </Link>
            </div>
          </div>
