  ...
  return (
    <section className="py-14 sm:py-20 overflow-hidden" style={{ background: '#fff' }}>
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0 mb-10 text-center">
        <h2 className="text-[28px] sm:text-[36px] font-bold text-[#0F1112] mb-3">20+ Payment Gateways Supported</h2>
        <p className="text-[#6b7280] text-[15px] max-w-[680px] mx-auto leading-6">
          PayPal · Stripe · Razorpay · Paytm · Flutterwave · Paystack · Mollie · Midtrans · Cashfree · Instamojo · Mercado Pago · Zitopay · Square · CinetPay · PayTabs · Billplz · Toyyibpay · PayFast · Manual Payment
        </p>
      </div>
