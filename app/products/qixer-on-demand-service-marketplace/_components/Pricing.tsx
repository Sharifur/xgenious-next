...
const BUNDLE_FEATURES = [
  ...
  { label: 'Buyer Flutter Mobile App', ok: true },
  { label: 'Seller / Provider Flutter App', ok: true },
  { label: 'Buyer Wallet System', ok: true },
  { label: 'Job Posting Module', ok: true },
  { label: 'Seller Subscription Plans', ok: true },
  { label: 'Live Chat Addon', ok: true },
  { label: 'Google Play + App Store Ready', ok: true },
  { label: 'Lifetime License + Free Updates', ok: true },
  { label: '6 Months Support', ok: true },
  { label: 'SaaS / White-label Rights', ok: false },
];
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-[1240px] mx-auto">
          ...
          <div
            ...
            style={{ background: '#0d0a2e', border: `2px solid ${COLOR}` }}
          >
            ...
            <div className="mb-5">
              ...
              <div className="flex items-baseline gap-2 mb-3">
                ...
                <span className="text-[15px]" style={{ color: '#7a76a8' }}>one-time</span>
              </div>
              ...
              <div className="rounded-xl p-3 flex flex-col gap-1.5" style={{ background: 'rgba(255,255,255,0.05)' }}>
                ...
                {[
                  ...
                  <div key={item} className="flex items-center justify-between">
                    ...
                    <span className="text-[12px] font-semibold line-through" style={{ color: '#4a4480' }}>{price}</span>
                  </div>
                ))}
            ...
            <Link
              href="/checkout?product=qixer-everything-bundle"
            ...
            <div className="flex flex-col gap-2.5">
              {BUNDLE_FEATURES.map((f) => (
                <div key={f.label} className="flex items-start gap-2.5 text-[13px]" style={{ color: f.ok ? '#c7c4ff' : '#4a4480' }}>
                  <CheckIcon ok={f.ok} />
                  {f.label}
                </div>
              ))}
          ...
          >
            ...
            <div className="mb-5">
              ...
              <div className="rounded-xl p-3 flex flex-col gap-1.5" style={{ background: 'rgba(167,139,250,0.07)' }}>
                ...
                {[
                  ...
                  'Launch unlimited service marketplaces',
                ].map((item) => (
            ...
            <Link
              href="/checkout?product=qixer-exclusive-pack"
              className="flex items-center justify-center gap-2 text-white font-bold text-[15px] rounded-xl py-3.5 mb-6 transition-all hover:opacity-90 hover:-translate-y-0.5"
