...
import { REVIEWS, COLOR, CODECANYON_URL } from './constants';
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0">
        ...
        <div className="text-center mb-12 max-w-[600px] mx-auto">
          <h2 className="text-[32px] sm:text-[44px] font-bold text-[#0F1112] leading-tight mb-4">
            What Our Customers Say<br className="hidden sm:block" /> About Qixer
          </h2>
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-[13px] font-medium mt-3 transition-colors hover:underline"
            style={{ color: COLOR }}
          >
            4.5/5 rating · 46 reviews · 712 sales on CodeCanyon ↗
          </Link>
        </div>
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-5 space-y-5">
          {REVIEWS.map((review) => (
            ...
            >
              ...
              <p className="text-[13px] font-medium" style={{ color: COLOR }}>
                by {review.name}
              </p>
            </div>
          ))}
