...
const STEPS = [
  {
    ...
    desc: 'Purchase Qixer with a one-time payment. Upload to any PHP 8.3+ server with MySQL 8+. Run the guided installer, configure your service categories, commission rates, and payment gateways, and go live — free cPanel installation included.',
  },
  {
    n: '02',
    title: 'Onboard Providers and Buyers',
    desc: 'Service providers register, create listings, and set their availability. Buyers download the Flutter app, search by location, browse services, and book in seconds.',
  },
  {
    n: '03',
    title: 'Grow Your Marketplace',
    desc: 'Manage everything from the Laravel admin panel — approve providers, configure subscription plans, monitor orders, process payouts, and launch promotions as your marketplace scales.',
  },
];
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0 max-w-[1100px] mx-auto">
        ...
        <div className="text-center mb-14 max-w-[600px] mx-auto">
          ...
          <p className="text-[15px] text-[#6b7280] leading-7">
            Qixer installs on any standard PHP hosting environment. No DevOps expertise required.
          </p>
        </div>
