import { CODECANYON_REVIEWS } from './constants';
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0">
        ...
        <div className="text-center mb-12 max-w-[600px] mx-auto">
          <h2 className="text-[32px] sm:text-[44px] font-bold text-[#0F1112] leading-tight mb-4">
            What Our Customers Think<br className="hidden sm:block" /> About Nazmart
          </h2>
          <p className="text-[#484848] text-[15px] sm:text-[17px] leading-7">
            Real reviews from verified CodeCanyon buyers — 525+ sales, 4.51 average rating.
          </p>
        </div>

        <div className="columns-1 sm:columns-2 lg:columns-3 gap-5 space-y-5">
          {CODECANYON_REVIEWS.map((review) => (
            <div
              key={review.name}
            ...
            >
              ...
              <p className="text-[13px] font-medium" style={{ color: '#2d6a00' }}>
                by {review.name}
              </p>
            </div>
          ))}
