...
const LINE_ICONS = ['chat', 'map', 'membership', 'wallet', 'ads', 'rtl', 'guest', 'blog', 'analytics', 'star', 'roles', 'gdpr'];
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0">
        ...
        <div className="text-center mb-12 max-w-[620px] mx-auto">
          ...
          <h2 className="text-[28px] sm:text-[40px] font-bold text-[#0F1112] leading-tight mb-4">
            A Complete Classified Ads Script — Everything Included
          </h2>
          <p className="text-[#484848] text-[15px] sm:text-[17px] leading-7">
            Every feature needed to run a profitable classified ads marketplace — live chat, Google Maps, memberships,
            analytics, and GDPR compliance — built in, with no extra subscriptions or third-party services required.
          </p>
        </div>
