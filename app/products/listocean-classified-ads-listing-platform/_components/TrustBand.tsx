        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-[1100px] mx-auto">
          ...
          <div>
            ...
            <p className="text-[#6b7280] text-[15px] leading-7 mb-8">
              ListOcean has a full live demo with open admin access. Browse listings, test the drag &amp; drop page
              builder, configure categories, and explore plugin settings yourself — then buy with confidence
              knowing exactly what you get. Every license ships with the full Laravel source code and lifetime updates.
            </p>
