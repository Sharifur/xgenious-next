      ...
      <div className="container-page px-4 sm:px-6 lg:px-0">
        ...
        <div className="text-center mb-12 max-w-[580px] mx-auto">
          ...
          <h2 className="text-[28px] sm:text-[40px] font-bold text-white leading-tight mb-4">
            From Purchase to Live Platform in 4 Steps
          </h2>
          <p className="text-[#9ca3af] text-[15px] leading-7">
            ListOcean is designed for a fast, guided setup. Follow these four steps and your classified
            marketplace will be live and accepting listings the same day.
          </p>
        </div>
