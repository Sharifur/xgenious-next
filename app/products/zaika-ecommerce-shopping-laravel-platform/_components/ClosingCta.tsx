    ...
    <section className="py-16 sm:py-20 lg:py-[100px]" style={{ background: DARK_BG }}>
      <div className="container-page px-4 sm:px-6 lg:px-0">
        <div className="max-w-[760px] mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[12px] font-semibold uppercase tracking-widest mb-6" style={{ background: `${COLOR}25`, color: '#ffb3cf' }}>
          ...
          <h2 className="text-[32px] sm:text-[44px] lg:text-[52px] font-bold text-white leading-tight mb-5">
            Launch Your Single Vendor Store This Week
          </h2>

          <p className="text-[15px] sm:text-[17px] leading-7 mb-8" style={{ color: '#f0d4e1' }}>
            Stop paying monthly platform fees and waiting months for a custom build. Zaika gives you a complete,
            SEO-ready single-vendor online store — page builder, 15+ gateways, advanced inventory, and full Laravel
            source — for less than a single month of a hosted platform.
          </p>
          ...
          <p className="text-[12px] mt-6" style={{ color: '#b07d96' }}>
