...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. The Extended License allows you to offer HelpNest as a paid service to unlimited clients. Stripe and PayPal subscription billing are built in, so you can create plans, charge clients monthly, and generate invoices — without writing billing logic from scratch.',
  },
  {
  ...
  },
  {
    ...
    a: 'Crisp, Intercom, and Tidio are SaaS tools that charge $29–$45 per month per workspace indefinitely. HelpNest is a one-time $59 purchase — self-hosted on your own server, full source code, no monthly fees, multi-tenant by design, and white-label rights included in the Extended License.',
  },
  {
    q: 'Which license do I need?',
    a: 'Choose the Regular License ($59) for a single internal deployment — one company, one chatbot. Choose the Extended License ($199) if you want to sell chatbot access to paying clients and build a recurring SaaS revenue stream.',
  },
  {
