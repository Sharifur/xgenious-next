    ...
    <section className="py-16 sm:py-20 lg:py-[100px]" style={{ background: DARK_BG }}>
      <div className="container-page px-4 sm:px-6 lg:px-0">
        <div className="max-w-[720px] mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[12px] font-semibold uppercase tracking-widest mb-6" style={{ background: `${COLOR}25`, color: '#a5b4fc' }}>
            Get Started Today
          </div>

          <h2 className="text-[32px] sm:text-[48px] font-bold text-white leading-tight mb-5">
            Your Multipurpose Business Website Starts Here
          </h2>

          <p className="text-[#9ca3af] text-[15px] sm:text-[17px] leading-7 mb-8">
            One platform. Nine business models. A no-code builder, 20+ payment gateways, RTL support, and a full support
            ticket system — all for a one-time price. No monthly fees. No platform commission on your revenue.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            >
              {`Purchase Nexelit — from $${REGULAR_PRICE}`}
            </a>
            <Link
              href={DEMO_URL}
              target="_blank"
