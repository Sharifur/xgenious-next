    ...
    <section className="relative overflow-hidden pt-[120px] pb-0 sm:pt-[140px]" style={{ background: LIGHT_COLOR }}>
      ...
      <div className="container-page px-4 sm:px-6 lg:px-0 flex flex-col items-center text-center gap-6 relative z-10 max-w-[900px] mx-auto">
        ...
        <div className="inline-flex items-center gap-2 bg-white/70 rounded-full px-4 py-1.5 border border-white/80 text-[13px] font-medium text-[#374151]">
          ...
          Multipurpose Website &amp; Business CMS — Laravel
        </div>
        ...
        <p className="text-[#4b5563] text-[15px] sm:text-[17px] leading-7 max-w-[640px]">
          <strong>Nexelit is a multipurpose website and business CMS built on Laravel.</strong> It ships with 9 built-in
          business modules (eCommerce, events, courses, appointments, donations, job posting, service packages, support tickets, and knowledgebase), 4
          drag &amp; drop builders, 20+ payment gateways, and RTL support — for a one-time price with no monthly fees.
        </p>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[13px] font-semibold text-[#0F1112]">4.72/5</span>
          <span className="text-[13px] text-[#6b7280]">· 183 reviews · 1,971+ sales on CodeCanyon</span>
        </div>
        ...
        <p className="text-[12px] text-[#6b7280]">One-time purchase · No monthly fees · Full Laravel source code · RTL support</p>
        ...
        <div className="mt-10 w-full max-w-[900px]">
          <div className="rounded-t-2xl overflow-hidden shadow-2xl border border-black/5">
            <Image
              src="/products/nexelit/hero-landing.png"
              alt="Nexelit multipurpose CMS — agency homepage with navigation, hero, and service cards"
              width={1964}
              height={2000}
