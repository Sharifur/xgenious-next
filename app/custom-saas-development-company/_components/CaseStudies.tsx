...
const CASES: CaseStudy[] = [
  ...
  },
  {
    ...
    description:
      'Laravel crowdfunding platform with drag-and-drop campaign builder, event ticket sales, 10+ payment gateways, and a configurable platform fee model — built for full operator control.',
    stats: [
