...
const features = [
  {
    ...
    desc: 'From 100 to 10M requests/day without re-architecture. Auto-scaled inference, message queueing, and burst handling — your agents don\'t fall over when the workload spikes.',
  },
  {
    num: '03',
    title: 'LLM Provider Agnostic',
    desc: 'OpenAI, Anthropic Claude, open-source models — we abstract the model layer so you can switch providers without touching agent logic. No lock-in to a single vendor\'s pricing or availability.',
  },
  {
    num: '04',
    title: 'Real-time Observability',
    desc: 'Every reasoning step, tool call, token count, and latency metric logged and queryable. Debug agents like microservices — not black boxes. Datadog, Sentry, and custom dashboards wired in by default.',
  },
  {
    num: '05',
    title: 'Secure by Default',
    desc: 'Prompt-injection defence, scoped tool permissions, encrypted memory stores, and rate limiting on every agent endpoint. Security is an architecture decision, not a last-sprint patch.',
  },
  {
    num: '06',
  ...
  },
  {
    ...
    desc: 'From kickoff to production. Most agencies take quarters — we ship in sprints with weekly demos, a staging environment, and a committed go-live date in the proposal.',
  },
];
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[#9ca3af] text-[14px] leading-[22px]">
                  SOC 2 patterns, isolated tenancy, audit logs, and PII redaction baked in from day one — not retrofitted after a security review flags it.
                </p>
              </div>
