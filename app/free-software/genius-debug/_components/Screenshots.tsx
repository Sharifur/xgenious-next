      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-8 pointer-events-none">
        <div className="relative w-full max-w-[1200px] pointer-events-auto">
          <button
            onClick={onClose}
            aria-label="Close"
            className="absolute -top-11 right-0 sm:top-0 sm:-right-11 w-9 h-9 rounded-full flex items-center justify-center bg-white/10 text-white hover:bg-white/20 transition-colors"
          >
          ...
          <button
            ...
            className="absolute top-1/2 -left-3 sm:-left-14 -translate-y-1/2 w-9 h-9 rounded-full flex items-center justify-center bg-white/10 text-white hover:bg-white/20 transition-colors"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          ...
          <button
            ...
            className="absolute top-1/2 -right-3 sm:-right-14 -translate-y-1/2 w-9 h-9 rounded-full flex items-center justify-center bg-white/10 text-white hover:bg-white/20 transition-colors"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
