  ...
  return (
    <section className="py-16 sm:py-20 bg-white">
      <div className="container-page px-4 sm:px-6 lg:px-0 max-w-[820px] mx-auto">
        ...
        <p className="text-[16px] text-[#484848] leading-8 mb-5">
          The system ships with a <strong>sequence builder</strong> for multi-step drip automation — now with <strong>A/B step variants</strong>, a <strong>Stats tab</strong>, and per-sequence sender overrides — plus <strong>inbound and outbound webhooks</strong> for your stack, and an <strong>AI-assisted template editor</strong> with spintax, <strong>multi-subject & preview-text shuffles</strong>, and <strong>conditional if/else blocks</strong>. Contacts support <strong>custom fields</strong> (text/number/date/url/boolean/dropdown) and server-side pagination, while sending rotates automatically across your own <strong>AWS SES</strong> and <strong>Gmail Workspace</strong> accounts, quota-aware, with bulk <strong>email verification</strong> (and per-contact click-to-verify + auto-suppression) before every send.
        </p>
