          ...
          <div className="col-span-12 lg:col-span-8 lg:col-start-3">
            ...
            >
              <div>
                ...
                <p className="text-[#6b7280] text-[14px]">Reach out and we&apos;ll help you get set up.</p>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-[#E5E7EC] flex flex-wrap gap-x-6 gap-y-2 text-[13px] text-[#6b7280]">
              ...
              <a href="https://en.wikipedia.org/wiki/Email_marketing" target="_blank" rel="noopener noreferrer" className="text-[#6b7280] hover:underline">Email Marketing — Wikipedia ↗</a>
            </div>
