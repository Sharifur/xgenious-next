...
const ROWS = [
  ...
  { feature: 'Guest ticketing (no login)', geniusSupport: 'Yes: form + email + magic link', zendesk: 'No: account required', freshdesk: 'No: account required' },
  { feature: 'SLA management', geniusSupport: 'Built in', zendesk: 'Higher tiers only', freshdesk: 'Higher tiers only' },
  ...
  { feature: 'GDPR / data sovereignty', geniusSupport: 'Full control', zendesk: 'Vendor-controlled', freshdesk: 'Vendor-controlled' },
