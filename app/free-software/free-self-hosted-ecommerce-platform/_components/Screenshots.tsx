...
const SHOTS = [
  { file: 'admin-dashboard.png', title: 'Admin Dashboard', caption: 'Revenue, orders, and quick actions at a glance.', w: 2000, h: 1160 },
  { file: 'admin-products.png', title: 'Product Catalogue', caption: 'Products, stock, and status across every category.', w: 2000, h: 1000 },
  { file: 'admin-product-edit.png', title: 'Product Editor', caption: 'Specs, SEO fields, and per-variant pricing and stock.', w: 879, h: 2000 },
  { file: 'admin-orders.png', title: 'Orders', caption: 'Order list with payment and fulfilment status.', w: 2000, h: 961 },
  { file: 'admin-order-detail.png', title: 'Order Detail', caption: 'Items, shipping, fraud check, and courier dispatch in one view.', w: 2000, h: 1971 },
  { file: 'admin-customer.png', title: 'Customer Profile', caption: 'Order history, saved addresses, and loyalty points per customer.', w: 2000, h: 1300 },
  { file: 'admin-loyalty-settings.png', title: 'Loyalty Program', caption: 'Points rules and membership tiers with a live preview.', w: 2000, h: 1147 },
  { file: 'admin-sales-report.png', title: 'Sales Report', caption: 'Revenue over time, by payment method, and top products, exportable to CSV.', w: 2000, h: 1070 },
  { file: 'storefront-home.png', title: 'Storefront', caption: 'The customer-facing store: featured pieces, categories, and new arrivals.', w: 627, h: 2000 },
  { file: 'storefront-product-cooling-stand.jpg', title: 'Product Page', caption: 'Pricing, stock, and trust badges on the storefront.', w: 1721, h: 2000 },
  { file: 'storefront-product-hoodie.png', title: 'Variant Selection', caption: 'Size and colour variants with per-variant pricing.', w: 2000, h: 1238 },
];
  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 sm:p-8 pointer-events-none">
        <div className="relative w-full max-w-[900px] max-h-[85vh] pointer-events-auto flex flex-col items-center">
          <button
            onClick={onClose}
            aria-label="Close"
          ...
          <div className="rounded-2xl overflow-hidden bg-black max-h-[75vh]">
            <Image
              src={`/free-software/genius-commerz/${shot.file}`}
              alt={`Genius Commerz ${shot.title}: ${shot.caption}`}
              width={shot.w}
              height={shot.h}
          ...
          {SHOTS.map((s, i) => (
            ...
            >
              <div className="relative overflow-hidden h-56">
                <Image
                  src={`/free-software/genius-commerz/${s.file}`}
                  alt={`Genius Commerz ${s.title}: ${s.caption}`}
                  fill
