...
const CASES: CaseStudy[] = [
  {
    ...
    description:
      'Flutter mobile platform for beauty professionals to book premium treatment rooms — digital smart lock access, Stripe payments, and zero on-site staff required.',
    stats: [
  ...
  },
  {
    ...
    tags: ['Flutter', 'Marketplace', 'Escrow Payments'],
  ...
  },
  {
    ...
    tags: ['Flutter', 'Home Services', 'Marketplace'],
  ...
  },
  {
    ...
    description:
      'Vehicle-aware booking marketplace connecting car owners with mechanics — vehicle model matching, real-time order tracking, 19+ payment gateways, and an Android mobile app.',
    stats: [
      { value: '19+', label: 'Payment Methods' },
      { value: 'Live', label: 'Order Tracking' },
      { value: 'Android', label: 'Mobile App' },
    ],
    tags: ['Android', 'Automotive', 'Marketplace'],
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-8 mb-8 sm:mb-10 lg:mb-14">
          ...
          <div className="max-w-[380px] lg:pt-2">
            <p className="text-[15px] leading-[24px] text-[#484848]">
              Real mobile products built for founders and growing businesses — from Flutter apps to Android marketplaces. Published scope, fixed pricing, shipped on schedule.
            </p>
          </div>
        </div>
