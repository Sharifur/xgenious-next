        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-[#484848] text-[15px] leading-6 max-w-[460px]">
              No black boxes. You see every step, own every decision, and have
              full visibility into where your project stands at all times.
            </p>
            ...
            <div className="mt-10 space-y-0">
              {processSteps.map((step, index) => (
                <div key={step.number} className="flex gap-5 relative">
                  ...
                  {/* Content */}
                  <div className="pb-7">
                    <h3 className="text-[16px] font-semibold text-[#0F1112] mb-1.5 leading-6">{step.title}</h3>
          ...
          {/* Right - Visual: focus / magnifying-glass aesthetic */}
          <div className="relative">
            <div className="rounded-3xl bg-[#F5F6F8] aspect-[4/5] overflow-hidden relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="relative">
                  ...
                  <div className="w-44 h-44 rounded-full bg-white/70 backdrop-blur-sm border-[6px] border-[#0F1112] shadow-2xl shadow-black/20 flex items-center justify-center">
                    <div className="w-28 h-28 rounded-2xl bg-[#F26B4E] flex items-center justify-center text-white text-4xl font-bold shadow-lg shadow-[#F26B4E]/30">
                      <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <path d="M14 14h20v20H14z" stroke="white" strokeWidth="3" strokeLinejoin="round" opacity="0.3" />
              ...
              <div className="absolute top-6 right-6 bg-white rounded-2xl shadow-xl shadow-black/5 p-4 border border-[#E5E7EC]">
                <p className="text-[10px] text-[#8A8F99] font-medium uppercase tracking-wider">Sprint Completion</p>
              ...
              <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-xl shadow-black/5 p-4 border border-[#E5E7EC]">
                <p className="text-[10px] text-[#8A8F99] font-medium uppercase tracking-wider">On-Time Delivery</p>
