  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex items-center rounded-xl border border-[#E5E7EC] bg-white overflow-hidden focus-within:border-[#3b82f6] focus-within:ring-2 focus-within:ring-[#3b82f6]/10 transition-colors">
              ...
              {matches.map((m, i) => (
                <div key={i} className="rounded-xl border border-[#E5E7EC] p-3 flex flex-col gap-1">
                  <div className="flex items-center gap-3 text-[12px]">
                    <span className="font-medium text-[#3b82f6]">Match {i + 1}</span>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="rounded-xl border border-[#E5E7EC] bg-white px-4 py-2.5 text-[14px] font-mono text-[#0F1112] placeholder:text-[#9ca3af] outline-none focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/10 transition-colors"
            />
          </div>
          {replaced && (
            <div className="flex flex-col gap-1.5">
