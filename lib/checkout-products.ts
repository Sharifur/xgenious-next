...
const PRODUCTS: Record<string, CheckoutProduct> = {
  ...
  'grenmart-extended-pack': {
    path: 'grenmart-extended-pack',
    name: 'Grenmart — Extended License',
    tagline: 'Organic & grocery Laravel eCommerce with the right to charge your end users.',
    price: 129,
    originalPrice: 199,
    badge: 'Best Value',
    features: [
      ...
      'RTL + 200+ languages',
      'Charge your own end users (SaaS / paid)',
      'Lifetime license validity',
      'Lifetime free updates',
      '6 months support',
      'Personal & commercial use',
    ...
    addons: [
      ...
      {
        path: 'grenmart-install-web',
        label: 'We Install & Launch It For You',
        description: 'Skip the setup. We deploy Grenmart on your server, configure payment gateways, and hand you a working store. Ready in 48 hours.',
        price: 99,
        originalPrice: 199,
        includes: [
  ...
  'grenmart-exclusive-pack': {
    path: 'grenmart-exclusive-pack',
    name: 'Grenmart — Exclusive License',
    tagline: 'Full source rights, branding removal, free installation, and priority support.',
    price: 249,
    originalPrice: 399,
    badge: 'Exclusive',
    features: [
