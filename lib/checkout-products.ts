...
const PRODUCTS: Record<string, CheckoutProduct> = {
  ...
  'nexelit-extended-pack': {
    ...
    tagline: 'Full CMS + extended rights to charge your end users. 12 months priority support.',
    price: 79,
    originalPrice: 149,
    ...
    addons: [
      ...
      },
      {
        ...
        description: 'Already have 12 months — add 6 more for continued priority support.',
        price: 49,
        originalPrice: 99,
        sidebarUpsell: true,
        includes: [
    ...
    addons: [
      {
        path: 'nexelit-support-6m',
        label: 'Extend to 18 Months Support',
        description: 'Already have 12 months — add 6 more for continued priority ticket support and bug fixes.',
        price: 39,
        originalPrice: 59,
        sidebarUpsell: true,
        includes: [
